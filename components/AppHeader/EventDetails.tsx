...
const EventDetails = () => {
  ...
  return (
    <div
      className={`absolute bottom-8 ${placementOfDetails} flex flex-col bg-linear-to-r from-blue-500 to-blue-600 text-white
         text-gray-700 px-3 py-1.5 rounded-e-md z-40 animate-fade-in-0.5 shadow-lg shadow-blue-500/20 max-w-[150px]`}
