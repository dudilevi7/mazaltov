...
const EventDetails = () => {
  ...
  return (
    <div
      className={`absolute bottom-8 ${placementOfDetails} flex flex-col bg-gray-100 border border-gray-200 px-1 py-0.5 rounded-md z-50 transition-all duration-300`}
