...
const AppSidebar = () => {
  ...
  const isRight = isRtl
  const ChevronIcon = isOpen ? (isRight ? faChevronRight : faChevronLeft) : isRight ? faChevronLeft : faChevronRight
  ...
  return (
    <div
      ...
      dir={isRtl ? 'rtl' : 'ltr'}>
      <div className={`flex flex-col h-full ${isOpen ? 'py-4 px-3 animate-fade-in-0.5' : 'py-4 px-0 items-center'}`}>
